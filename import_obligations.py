    ...
    try:
        sig, is_created = Signaletique.objects.update_or_create(
            ...
            defaults={
                ...
                'titre': str(titre)[:500] if titre else f'[Obligation] {isin_str}',
